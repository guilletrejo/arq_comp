...
vlog -work work my_clock_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax my_clock_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.my_clock_tb work.glbl
